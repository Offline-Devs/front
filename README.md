...
وب‌اپلیکیشن فارسی و راست‌چین آینده سبز برای مدیریت آزمون‌ها، تحلیل اشتباهات، گزارش‌های عملکرد تحصیلی
و مدیریت دانش‌آموزان. این برنامه فقط با تنظیمات محیط production اجرا می‌شود.
