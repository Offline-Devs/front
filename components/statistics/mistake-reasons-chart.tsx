...
export function MistakeReasonsChart({ data }: { data: Record<string, number> }) {
  ...
  return (
    <div className="grid gap-4">
      <div role="img" aria-label="نمودار دلایل اشتباه" className="h-72 w-full" dir="ltr">
        <ResponsiveContainer width="100%" height="100%">
          <PieChart>
            ...
            <Tooltip formatter={(value) => [formatNumber(Number(value)), "تعداد"]} />
          </PieChart>
        </ResponsiveContainer>
      </div>
      <TableContainer>
        <DataTable>
          <TableHeader>
            <TableRow>
              <TableHead>دلیل اشتباه</TableHead>
