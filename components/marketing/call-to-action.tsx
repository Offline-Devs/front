...
export function CallToAction() {
  return (
    <section className="page-container py-12 sm:py-16">
      <div className="brand-grid relative grid gap-6 overflow-hidden rounded-lg bg-[var(--brand-strong)] px-6 py-10 text-primary-foreground shadow-[var(--shadow-lg)] sm:px-10 md:grid-cols-[1fr_auto] md:items-center">
